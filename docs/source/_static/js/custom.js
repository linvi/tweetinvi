...
function improveIteratorCodeBlocks() {
    ...
    iterableCodeBlocks.forEach(element => {
        element.insertAdjacentHTML("afterbegin", '<a class="iterator" href="../twitter-api-v1.1/iterators.html"><b>iterators</b> <span class="fa fa-arrow-circle-right" style="margin-left: 10px;"></span></a>');
    });
}
...
function addGithubLink() {
    ...
    <span style="position: absolute; top: 6px; left: 80px;">Version 5.0</span>`;
