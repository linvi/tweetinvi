...
namespace Tweetinvi.Core.Injectinvi
{
    public class TweetinviCoreModule : ITweetinviModule
    {
        ...
        public void Initialize(ITweetinviContainer container)
        {
            ...
            container.RegisterType<ITaskFactory, TaskFactory>(RegistrationLifetime.InstancePerApplication);
            ...
            container.RegisterType<IAsyncContextPreparer, AsyncContextPreparer>(RegistrationLifetime.InstancePerApplication);
