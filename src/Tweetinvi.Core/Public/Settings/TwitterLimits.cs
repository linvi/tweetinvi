...
namespace Tweetinvi
{
    public class TwitterLimits
    {
        ...
        public TwitterLimits(TwitterLimits source)
        {
            ...
            LISTS_GET_USER_SUBSCRIPTIONS_MAX_PAGE_SIZE = source.LISTS_GET_USER_SUBSCRIPTIONS_MAX_PAGE_SIZE;
            ...
            SEARCH_TWEETS_MAX_PAGE_SIZE = source.SEARCH_TWEETS_MAX_PAGE_SIZE;
            SEARCH_USERS_MAX_PAGE_SIZE = source.SEARCH_USERS_MAX_PAGE_SIZE;
