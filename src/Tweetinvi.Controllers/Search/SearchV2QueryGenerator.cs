...
namespace Tweetinvi.Controllers.Search
{
    ...
    public class SearchV2QueryGenerator : ISearchV2QueryGenerator
    {
        ...
        public string GetSearchTweetsV2Query(ISearchTweetsV2Parameters parameters)
        {
            ...
            query.AddParameterToQuery("end_time", parameters.EndTime?.ToString("yyy-MM-ddTHH:mm:ssZ", CultureInfo.InvariantCulture));
            ...
            query.AddParameterToQuery("start_time", parameters.StartTime?.ToString("yyy-MM-ddTHH:mm:ssZ", CultureInfo.InvariantCulture));
