...
namespace Testinvi.Tweetinvi.Logic
{
    ...
    public class TweetDTOTests
    {
        ...
        {
            var tweet = InitTweet(_simpleExtendedTweet);
        ...
        {
            var tweet = InitTweet(_extendedTweetWith1Mention);
        ...
        private static string _extendedTweetWith1Mention = @"{
        ...
        static string _simpleExtendedTweet = @"{
