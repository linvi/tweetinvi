...
namespace Testinvi.TweetinviControllers.TweetTests
{
    ...
    public class TweetQueryExecutorTests
    {
        ...
        [TestMethod]
        public void PublishTweetInReplyTo_WithTweetDTOToReplyTo_ReturnsTwitterAccessorResult()
        {
            // Arrange
            var queryExecutor = CreateTweetQueryExecutor();
            var tweetDTO = A.Fake<ITweetDTO>();
            ...
            _fakeTwitterAccessor.CallsTo(x => x.ExecutePOSTQuery<ITweetDTO>(query, null)).Returns(expectedResult);
        ...
        [TestMethod]
        public void PublishTweetInReplyTo_WithTweetIdToReplyTo_ReturnsTwitterAccessorResult()
        {
            // Arrange
            var queryExecutor = CreateTweetQueryExecutor();
            var tweetDTO = A.Fake<ITweetDTO>();
