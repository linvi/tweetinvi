...
namespace Testinvi.TweetinviControllers.TweetTests
{
    ...
    public class TweetJsonControllerTests
    {
        ...
        public void PublishTweet_WithNullTweet_ThrowArgumentException()
        {
            // Arrange
            var queryExecutor = CreateTweetJsonController();

            // Act
            queryExecutor.PublishTweet((ITweet)null);
        }

        [TestMethod]
        public void PublishTweet_WithTweet_ReturnsResponse()
        {
            // Arrange
            var queryExecutor = CreateTweetJsonController();
            ...
            // Act
            var result = queryExecutor.PublishTweet(tweet);
        ...
        [TestMethod]
        public void PublishTweet_WithTweetDTO_ReturnsResponse()
        {
            // Arrange
            var queryExecutor = CreateTweetJsonController();
            var tweetDTO = A.Fake<ITweetDTO>();
        ...
        #region PublishTweetInReplyTo

        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void PublishNullTweetInReplyTo_WithTweetToReplyTo_ThrowArgumentException()
        {
            // Arrange
            var queryExecutor = CreateTweetJsonController();
            ...
            tweetToReplyTo.CallsTo(x => x.TweetDTO).Returns(tweetToReplyToDTO);
            ...
            // Act
            queryExecutor.PublishTweetInReplyTo(null, tweetToReplyTo);
        }

        [TestMethod]
        public void PublishTweetInReplyTo_WithTweetToReplyTo_ReturnsResponse()
        {
            // Arrange
            var queryExecutor = CreateTweetJsonController();
            ...
            _fakeTweetQueryGenerator.CallsTo(x => x.GetPublishTweetInReplyToQuery(tweetDTO, tweetToReplyToDTO)).Returns(query);
            _fakeTwitterAccessor.ArrangeExecuteJsonPOSTQuery(query, expectedResult);

            // Act
            var result = queryExecutor.PublishTweetInReplyTo(tweet, tweetToReplyTo);
        ...
        [TestMethod]
        public void PublishTweetDTOInReplyTo_WithTweetDTOToReplyTo_ReturnsResponse()
        {
            // Arrange
            var queryExecutor = CreateTweetJsonController();
            var tweetDTO = A.Fake<ITweetDTO>();
            ...
            // Act
            var result = queryExecutor.PublishTweetInReplyTo(tweetDTO, tweetToReplyToDTO);
        ...
        [TestMethod]
        public void PublishTweetDTOInReplyTo_WithTweetIdToReplyTo_ReturnsResponse()
        {
            // Arrange
            var queryExecutor = CreateTweetJsonController();
            var tweetDTO = A.Fake<ITweetDTO>();
            ...
            _fakeTweetQueryGenerator.CallsTo(x => x.GetPublishTweetInReplyToQuery(tweetDTO, tweetIdToReplyTo)).Returns(query);
            _fakeTwitterAccessor.ArrangeExecuteJsonPOSTQuery(query, expectedResult);

            // Act
            var result = queryExecutor.PublishTweetInReplyTo(tweetDTO, tweetIdToReplyTo);
