...
namespace Testinvi.Tweetinvi.Credentials.RateLimitTests
{
    ...
    public class RateLimitCacheManagerTests
    {
        ...
        public void TestInitialize()
        {
            ...
            _fakeTwitterRequester.CallsTo(x => x.ExecuteQuery(_twitterQuery)).Returns(TEST_QUERY);
            ...
            _fakeTwitterQueryFactory.CallsTo(x => x.Create(TEST_QUERY, It.IsAny<HttpMethod>(), It.IsAny<IOAuthCredentials>())).Returns(_twitterQuery);
        }
        ...
        public void GetQueryRateLimit_TokenRateLimitsIsNull_Refreshes()
        {
            ...
            _fakeRateLimitCache.CallsTo(x => x.RefreshEntry(It.IsAny<IOAuthCredentials>(), It.IsAny<ITokenRateLimits>())).MustHaveHappened(Repeated.Exactly.Once);
        }
        ...
        public void GetQueryRateLimit_QueryCannotBeMatched_ReturnsNull()
        {
            ...
            _fakeRateLimitCache.CallsTo(x => x.RefreshEntry(It.IsAny<IOAuthCredentials>(), It.IsAny<ITokenRateLimits>())).MustNotHaveHappened();
        }
