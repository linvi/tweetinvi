...
namespace Tweetinvi.Logic
{
    ...
    public class LoggedUser : User, ILoggedUser
    {
        ...
        {
            return ExecuteLoggedUserOperation(() => BlockUser(user.UserDTO));
        }
        ...
        {
            return ExecuteLoggedUserOperation(() => UnBlockUser(user.UserDTO));
        }
        ...
        {
            ExecuteLoggedUserOperation(() => _tweetController.PublishTweet(tweet));
