...
namespace Tweetinvi.Controllers.Properties
{
    internal static class Resources
    {
        ...
        /// <summary>
        ///   Looks up a localized string similar to https://api.twitter.com/1.1/account/update_delivery_device.json?{0}?.
        /// </summary>
        public static string Account_UpdateDeliveryDevice = "https://api.twitter.com/1.1/account/update_delivery_device.json?{0}";
